<?php
session_start();
if(!isset($_SESSION['admin'])) die("Access denied. Admin only.");
...
echo "<table border='1' style='border-collapse: collapse;'><tr><th>Name</th><th>Position</th><th>Votes</th><th>Percentage</th></tr>";
